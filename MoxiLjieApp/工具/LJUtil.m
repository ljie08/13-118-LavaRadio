...
//属性字符串，设置关键字颜色
+ (NSMutableAttributedString *)setMainColorForKeywords:(NSString *)keywords mainStr:(NSString *)mainStr {
    NSRange range = [mainStr rangeOfString:keywords];
    NSMutableAttributedString *attributeStr = [[NSMutableAttributedString alloc] initWithString:mainStr];
